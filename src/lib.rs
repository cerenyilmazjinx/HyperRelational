// src/lib.rs
/*
 * Core library for HyperRelational
 */
...
#[derive(Debug)]
pub struct HyperRelationalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HyperRelationalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HyperRelational processing");
    
    let mut processor = HyperRelationalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HyperRelationalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HyperRelationalProcessor::new(false);
